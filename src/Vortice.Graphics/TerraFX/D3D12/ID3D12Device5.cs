...
internal unsafe partial struct ID3D12Device5
{
    public void** lpVtbl;
    ...
    public TFeature CheckFeatureSupport<TFeature>(D3D12_FEATURE d3D12Feature) where TFeature : unmanaged
    {
        TFeature feature = default;
        ThrowIfFailed(CheckFeatureSupport(d3D12Feature, &feature, (uint)sizeof(TFeature)));
        return feature;
    }
